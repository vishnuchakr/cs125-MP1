...
public class PrintLinesTest {
    ...
    /** Timeout for grading test. Solution takes 176 ms.*/
    private static final int GRADING_TEST_TIMEOUT = 4000;
    ...
    public void gradePrintLines() {
        for (Map.Entry<PrintLinesForInput, String[]> precomputedResult : PRECOMPUTED_RESULTS
            ...
            PrintLines.linePrinter(input.actress, input.contents.split("\\R"));
            ...
            for (int outputLine = 0; outputLine < output.length; outputLine++) {
                Assert.assertEquals(output[outputLine], expectedOutput[outputLine],
                        "Problem on line " + outputLine + ":");
            }
        }
    }
    ...
    public static class PrintLinesForInput {
        ...
        /**
         * Create a new set of testing inputs for linePrinter.
         *
        ...
        public PrintLinesForInput(final String setActress, final String setContentsPath) {
			...
			try {
                ...
                Scanner contentsScanner = new Scanner(contentsFile, StandardCharsets.UTF_8);
    ...
    public PrintLinesTest() {
        ...
        PrintLinesTest.PRECOMPUTED_RESULTS
            .put(new PrintLinesForInput("CHUCHU", "Rent.txt"),
                    new String[]{
                    });
